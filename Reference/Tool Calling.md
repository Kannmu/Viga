Tool Calling [​](about:blank#tool-calling)
==========================================
...
OpenAI Chat Completion API [​](about:blank#openai-chat-completion-api)
----------------------------------------------------------------------

### How it works [​](about:blank#how-it-works)
...
#### Tool calling flow [​](about:blank#tool-calling-flow)
...
### Tool calling example [​](about:blank#tool-calling-example)
...
### Defining a function tool (`function`) [​](about:blank#defining-a-function-tool-function)
...
#### Token usage [​](about:blank#token-usage)
...
### Handling tool calls (Tool calling) [​](about:blank#handling-tool-calls-tool-calling)
...
### Response format [​](about:blank#response-format)
...
[
  ...
  },
  {
    ...
    "function": {
      "name": "send_email",
      "arguments": "{\"to\":\"[[email protected]](https://zenmux.ai/cdn-cgi/l/email-protection)\",\"body\":\"Hi bob\"}"
    }
  }
]
```
...
#### Formatting results [​](about:blank#formatting-results)
...
#### Merging results into the final response [​](about:blank#merging-results-into-the-final-response)
...
### Other configuration [​](about:blank#other-configuration)

#### Controlling tool calling behavior (`tool_choice`) [​](about:blank#controlling-tool-calling-behavior-tool-choice)
...
### Streaming [​](about:blank#streaming)
...
OpenAI Responses API [​](about:blank#openai-responses-api)
----------------------------------------------------------
...
### Tool definition [​](about:blank#tool-definition)
...
### Complete example [​](about:blank#complete-example)
...
### Response format [​](about:blank#response-format-1)
...
### `tool_choice` parameter [​](about:blank#tool-choice-parameter)
...
Anthropic Messages API [​](about:blank#anthropic-messages-api)
--------------------------------------------------------------
...
### Tool definition [​](about:blank#tool-definition-1)
...
### Complete example [​](about:blank#complete-example-1)
...
### Response format [​](about:blank#response-format-2)
...
### `tool_choice` parameter [​](about:blank#tool-choice-parameter-1)
...
### Parallel tool calls [​](about:blank#parallel-tool-calls)
...
Google Vertex AI API [​](about:blank#google-vertex-ai-api)
----------------------------------------------------------

Google Vertex AI’s Gemini models support function calling via the `tools` parameter.

### Tool definition [​](about:blank#tool-definition-2)
...
### Complete example [​](about:blank#complete-example-2)
...
### Response format [​](about:blank#response-format-3)
...
### Function calling modes [​](about:blank#function-calling-modes)
...
### Parallel function calls [​](about:blank#parallel-function-calls)
...
Protocol comparison [​](about:blank#protocol-comparison)
--------------------------------------------------------
